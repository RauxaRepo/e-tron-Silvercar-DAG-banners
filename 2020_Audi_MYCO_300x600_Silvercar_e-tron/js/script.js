...
function preloadImage(f) {
    ...
    a = [
        "Silvercar_etron_300x600_fr1.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundTwo.src = "Silvercar_etron_300x600_fr2.jpg"
    if(isRetinaDisplay()){
    ...
    if ("12|#fff||||18,560".split("|")[1] != "") s.innerHTML += ".cta { color: " + "12|#fff||||18,560".split("|")[1] + "; }\n\n";
    if ("12|#fff||||18,560".split("|")[5] != "") s.innerHTML += ".cta { left: " + "12|#fff||||18,560".split("|")[5].split(",")[0] + "px; top: " + "12|#fff||||18,560".split("|")[5].split(",")[1] + "px; }\n";
...
function playAd(){
    ...
    if("9|#fff|245,566" !=""){
        replay.style.fontSize = parseFloat("9|#fff|245,566".split("|")[0]) + "px";
        replay.style.left = parseFloat("9|#fff|245,566".split("|")[2].split(",")[0]) + "px";
        replay.style.top = parseFloat("9|#fff|245,566".split("|")[2].split(",")[1]) + "px";
        replay.style.color = "9|#fff|245,566".split("|")[1];
        if(parseFloat("9|#fff|245,566".split("|")[2].split(",")[1]) < 400){
            isLong = true;
        }
    }
    ...
    if("<span style='font-size:138%'><span style='color:#aaa'>View key offer details.</span></span>"){
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        TweenMax.to(inner_headline, .63, {y:300, rotate:.01, ease:Power3.easeInOut});
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "Silvercar_etron_300x600_fr3.jpg";
            secondFrame = true;
    ...
    inner_headline.addEventListener("transitionend", function f(e){
        ...
        if("" != "") {
            ...
            var l = document.createElement("img");
                ...
                l.src = "Silvercar_etron_300x600_ef.png";
...
function resizeHeadline(){
    ...
    if(b.indexOf("|") != -1){
        ...
        if(b_text[(b_text.length-1)].length > 10){
            ...
            copySizeTwo = "large"
        } else if((b_text[(b_text.length-2)].length) > 10){
            copySizeTwo = "small";
        } else if((b_text[(b_text.length-2)].length) > 6){
            copySizeTwo = "medium";
        } else if(b_text[1].length <= 6){
            copySizeTwo = "large";
        } 
    } else{
        var b_text = b.split(" ");
...
function normalizeHeadline(f) {
    ...
    if(secondFrame){
        inner_headline.style.top = 55 + (245 - inner_headline.getBoundingClientRect().height)/2 + "px";
        if ("|#fff|".split("|")[2] != "") {
